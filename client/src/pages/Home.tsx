  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-br from-[#f8eff0] via-[#faf5f7] to-[#f5f0f5] flex items-center justify-center overflow-hidden relative">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute top-10 left-10 w-32 h-32 bg-gradient-radial from-[#ffc0cb] to-transparent opacity-20 rounded-full blur-3xl animate-pulse-scale" />
        <div className="absolute bottom-20 right-20 w-40 h-40 bg-gradient-radial from-[#e6d5f8] to-transparent opacity-20 rounded-full blur-3xl animate-float-slow" />
        <div className="absolute top-1/3 right-10 w-24 h-24 bg-gradient-radial from-[#d4a5d4] to-transparent opacity-15 rounded-full blur-2xl animate-bounce-gentle" />
      </div>
      ...
      <div className="relative z-10 flex items-center justify-center w-full px-4 sm:px-6">
        ...
        {currentStep === 4 && <Step5 onNext={handleNext} />}
        {currentStep === 5 && <Step6 />}
      </div>
    </div>
  );
